...
- 夹具 `CLM-SC03-001`：材料齐 + `endorsement_flags=["PA-ACC-END-001"]` → `decision_type=reduce` / `gate_status=ADJUSTING`
- KB：主险 `ART-6-DEDUCT`（100/100%）被批单 `END-2-DEDUCT`（500/80%）覆盖；理算 10000→7600
